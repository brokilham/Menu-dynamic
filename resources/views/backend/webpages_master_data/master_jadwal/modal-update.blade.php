<div class="modal fade bs-modal-sm" id="modal-update"  role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn green" id="btn-update-mstr-jabatan">Save</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">update Master jabatan</span>
                        </div>
                    </div>
