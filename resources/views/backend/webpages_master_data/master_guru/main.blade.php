        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Master Guru</span>
                </div>              
            </div>
...
@include('backend.webpages_master_data.master_guru.modal-add') 
@include('backend.webpages_master_data.master_guru.modal-update') 
@endsection
