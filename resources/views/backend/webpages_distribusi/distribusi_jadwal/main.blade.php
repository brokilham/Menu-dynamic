        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Distribusi Jadwal</span>
                </div>              
            </div>
...
@include('backend.webpages_distribusi.distribusi_jadwal.modal-add') 
@include('backend.webpages_distribusi.distribusi_jadwal.modal-update') 
@endsection
